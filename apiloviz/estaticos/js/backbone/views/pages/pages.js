...
define([
    ...
    '../../models/menu',    
    '../app/menu',
], function ($, _, Backbone, swig,Head,PagesCollection,PaginaModel,BloqueView,CarruselProducto,ProductosTotal,Productos,MenuModel,Menu) {
    'use strict';

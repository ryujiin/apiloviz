...
define([
    ...
    'backbone',
    'swig',
    '../../models/catalogo/productoSingle',
    '../../collections/catalogo/productos',
    ...
    '../../models/comentario',
    'carro',
], function ($, _, Backbone, swig,ProductoModel,ProductosCollections,ComentariosCollection,BreadView,Galeria_full,Galeria_mobil,AddToCart,LineaModel,Relacionados,Estrellas,Comentarios,NuevoComentario,Head,ComentarioModel,Carro) {
    'use strict';
    ...
    var ProductoSinglesView = Backbone.View.extend({
        ...
        collection: ProductosCollections,

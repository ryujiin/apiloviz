    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restricciones', models.ManyToManyField(blank=True, to='ubigeo.Ubigeo')),
            ],
        ),
        migrations.CreateModel(
            name='MetodoPago',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_pedido', models.CharField(choices=[('autenticado', 'Autenticado - El usuario se encuentra autenticado y el pedido le pertenece'), ('metodo_envio', 'Metodo de Envio - Ya coloco el metodo de envio, esperando metodo de pago'), ('metodo_pago', 'Metodo de Pago - Ya selecciono el metodo de pago'), ('esperando_pago', 'Esperando Pago - Ya selecciono el metodo de pago, pero aun esta esperandose el pago'), ('pagado', 'Pagado - El pago se realizo correctamente, espere el envio del producto'), ('error_pago', 'Error en Pago - Ocurrio un error al pagar'), ('enviado', 'Enviado - El producto fue enviado'), ('devuelto', 'Devuelto - El producto fue devuelto')], default='autenticado', max_length=120)),
